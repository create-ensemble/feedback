...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 279.0, 627.0, 28.0, 20.0 ],
					"text" : "old:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 309.0, 627.0, 468.0, 22.0 ],
					"text" : "nice -n 20 /usr/local/bin/dot -Kcirco -Tpng -Gsize=3\\,3\\\\! -Gdpi=200 -Gratio=fill $1 -o $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 40.0, 601.0, 47.0, 22.0 ],
					"text" : "delay 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 627.0, 54.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 653.0, 125.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "", "clear" ],
					"patching_rect" : [ 40.0, 679.0, 59.0, 22.0 ],
					"text" : "t b l clear"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 40.0, 723.0, 55.0, 22.0 ],
					"text" : "jit.matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 753.0, 25.0, 25.0 ]
				}
